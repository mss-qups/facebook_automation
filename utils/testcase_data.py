...
# credential
# account = ["ahsan.kaisar@gmail.com", "1791859501"]
account = ["asit.hossain.qups@gmail.com", "bijoy.das.qups@gmail.com","dulal.bhowmik1993@gmail.com","ehsan.adil.bd@gmail.com"]
# password = ["asdfghqwerty#123", "QUPS@asdfgh12"]
password = ["ASDFGH@12", "ASDFGH@12", "ASDFGH@12", "ASDFGH@12"]
